...
public class ApartmentAccommodationService implements AccommodationService {

    private AccommodationRepository accommodationRepository;

    public ApartmentAccommodationService(@Qualifier("accommodationRepository") AccommodationRepository accommodationRepository) {
